...
<body>
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <a class="dropdown-item" href="user/index.php">Peternak</a>
                                        </div>
                                    </li>
                                    <li class="nav-item">
    ...
    <section class="banner_part">
        <img src="img/aku.jpg" alt="">
        <div class="container">
            <div class="row align-content-center">
                <div class="col-lg-7 col-xl-6">
                    <div class="banner_text">
                        <h5>Selamat Datang di</h5>
                        <h1>Dinas Peternakan</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5">
                    <div class="about_text">
                        ...
                        <a href="about.php" class="btn_1">Klik disini</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5">
                    <div class="about_text">
                        <img src="img/about_icon.png" class="about_icon" alt="">
                        <h2>Info Kesehatan hewan peliharaan</h2>
                        ...
                        <a href="blog.html" class="btn_1">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
        </div>
